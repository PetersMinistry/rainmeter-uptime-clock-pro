...
Beta build history is tracked in `CHANGELOG.md`. Release preflight steps are tracked in `RELEASE_CHECKLIST.md`.
...
- Keep the project-root `RMSKIN.ini` at the package root.
